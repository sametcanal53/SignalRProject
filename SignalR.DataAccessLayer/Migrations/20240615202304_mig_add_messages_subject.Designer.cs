...
namespace SignalR.DataAccessLayer.Migrations
{
    ...
    [Migration("20240615202304_mig_add_messages_subject")]
    partial class mig_add_messages_subject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.FeatureDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.FeatureDetail", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.Feature", "Feature")
            ...
            modelBuilder.Entity("SignalR.EntityLayer.Entities.SocialMedia", b =>
                {
                    b.HasOne("SignalR.EntityLayer.Entities.Contact", "Contact")
